...
void translateGL(Pos *p, double multiple) {
  glTranslated(p->x * multiple, p->y * multiple, 0);
}
#define ApplyTranslation(t) translateGL(t, 1)
#define CancelTranslation(t) translateGL(t, -1)
